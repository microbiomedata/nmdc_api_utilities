...
2. Create a release in Github. Using the convention `vx.x.x` as the title and new tag. Generate the notes automatically and add more if desired.
3. Publish release. The GHA workflow will take care of the rest.
